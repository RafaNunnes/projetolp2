 ...
 * O servidor inicia o socket para comunicação com o servidor do bar
 * Inicia o buffer e o produtor, que gera um taxi a cada 5 segundos
 * se o servidor receber "request" via UTF, checa se há taxi no buffer e "manda" o primeiro da fila (fetch no buffer)
